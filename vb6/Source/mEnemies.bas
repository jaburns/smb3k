...
'    .BeginScene 25
'        UpdateInput
'        .SetFont "Courier New", 8, True, False, False, False
'        .DrawSurface surfList.TitleScreen, 0, 0, 640, 480, 0, 0
'        If JoystickExists Then
'            .DrawText "Joystick Enabled!", 250, 400, vbGreen
'        Else
'            .DrawText "No Joystick Found. Hit -J- to search", 180, 400, vbRed
'        End If
'        .DrawText "[Jump]:New Game  [Shoot]:Load   [ESC]:Quit", 150, 415, &HFF0000
'        .DrawSurface surfList.FadeMask, 0, 0, 16, 16, 0, 0, 640, 480, , CSng(i), 0, 0, 0
'    .EndScene
'    Next i
'    Do
'        If lEscapeCount > 0 Then lEscapeCount = lEscapeCount - 1
'        If GameKeyDown(Quit) And lEscapeCount = 0 Then Exit Sub
'        If GameKeyDown(Jump) Then Exit Do
'        If GameKeyDown(Shoot) Then
'        .SetFont "Courier New", 8, True, False, False, False
'            While Not GameKeyDown(Quit)
'            .BeginScene 25
'                .DrawSurface surfList.TitleScreen, 0, 0, 640, 480, 0, 0
'                .DrawText "Choose slot or press [ESC]", 220, 400, &HFF0000
'                For i = 1 To 5
'                    .DrawText CStr(i) & " - " & oSaveGameData.gameSlot(i).sSaveString, 230, 280 + (15 * (i - 1)), 0
...
'            End If
'            .DrawText "[Jump]:New Game  [Shoot]:Load   [ESC]:Quit", 150, 415, &HFF0000
'            If GameKeyDown(DebugB) Then DebugModeEnabled = True
'            If DebugModeEnabled Then .DrawText "DEBUG MODE", 0, 0, vbWhite, 0
'        .EndScene
'    Loop
...
'        .DrawSurface surfList.TitleScreen, 0, 0, 640, 480, 0, 0
'        .SetFont "Courier New", 8, True, False, False, False
'        .DrawText "...Loading...", 260, 415, &HFF0000
'        .DrawSurface surfList.FadeMask, 0, 0, 16, 16, 0, 0, 640, 480, , CSng(i), 0, 0, 0
'    .EndScene
'    Next i
'    End With
